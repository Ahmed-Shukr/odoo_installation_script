...
REQ_FILE="/tmp/odoo_requirements.txt"
##
...
wget -O ${REQ_FILE} https://github.com/odoo/odoo/raw/${OE_VERSION}/requirements.txt
sed -i "s|^gevent==21\.8\.0 ; sys_platform != 'win32' and python_version == '3.10'.*|gevent==21.12.0 ; sys_platform != 'win32' and python_version == '3.10'  # (Jammy)|" ${REQ_FILE}
sudo -H pip3 install -r ${REQ_FILE}
